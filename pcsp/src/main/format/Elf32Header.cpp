...
void Elf32Header::read(std::ifstream &f) { f.read((char *)&data, sizeof(data)); }

bool Elf32Header::isValid() const { return data.e_magic == 0x464C457F; }

bool Elf32Header::isMIPSExecutable() const { return data.e_machine == 8; }
bool Elf32Header::isPRXDetected() const { return data.e_type == 0xFFA0; }

bool Elf32Header::requiresRelocation() const { return isPRXDetected() || (data.e_entry < MemoryMap::START_RAM); }
